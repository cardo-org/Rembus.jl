...
@testset "Rembus" begin
    ...
    if GROUP == "all" || GROUP == "server"
        ...
        @time @safetestset "broker_connect" begin
            include("server/test_broker_connect.jl")
        end
    ...
    if GROUP == "all" || GROUP == "errors"
        ...
        @time @safetestset "zmq_invalid_message" begin
            include("errors/test_zmq_invalid_message.jl")
        end
